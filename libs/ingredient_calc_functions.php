...
function return_shopping_list_obj($arr_my_items, $arr_recipes)
{
//$arr_my_items is a simple array of strings
//$arr_recipes is an object 
...
//take only top 3 high scoring recipes
	$arr_data = array_slice($arr_data, 0, 3, TRUE);
